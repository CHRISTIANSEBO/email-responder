  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Main navigation header">
        <div className="sm-logo" aria-label="Brand">
          {logoText ? (
      ...
      <aside id="staggered-menu-panel" ref={panelRef} className="staggered-menu-panel" aria-hidden={!open}>
        <div className="sm-panel-inner">
          {displaySocials && socialItems && socialItems.length > 0 && (
            <div className="sm-socials sm-socials-top" aria-label="Quick actions">
                  ...
                  <li key={s.label + i} className="sm-socials-item">
                    {s.onClick ? (
                      <button
                        ...
                        onClick={() => { s.onClick!(); if (closeOnItemClick) closeMenu(); }}
                      >
                        <span className="sm-social-text-wrap">
                          <span className="sm-social-text-inner">
                            <span>{s.label}</span>
                ...
                <li className="sm-panel-itemWrap" key={it.label + idx}>
                  {it.onClick ? (
                    <button
                      ...
                      data-index={idx + 1}
                      onClick={() => { it.onClick!(); if (closeOnItemClick) closeMenu(); }}
                    >
                ...
                {recentChats.map(chat => (
                  <li key={chat.id} className="sm-recents-item">
                    <button
                      ...
                      onClick={() => { onLoadChat?.(chat.id); if (closeOnItemClick) closeMenu(); }}
                    >
                      {chat.title}
                    </button>
                    {onDeleteChat && (
